...
$zipName = "AZURE.LOCAL.INFO.CAPTURES.Session(ALICS)2.24.zip"
$folderName = "AZURE.LOCAL.INFO.CAPTURES.Session(ALICS)2.24"
#$downloadUrl = "https://github.com/Louisjreeves/WinClusArcHelper/raw/refs/heads/main/$zipName"
$downloadUrl = "https://github.com/Louisjreeves/WinClusArcHelper/raw/refs/heads/main/AZURE.LOCAL.INFO.CAPTURES.Session(ALICS)2.24.zip"
...
try {
 ...
 $scriptFileName = "AZURE.LOCAL.INFO.CAPTURES.Session(ALICS)2.24.ps1"
